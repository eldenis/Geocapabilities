...
namespace Console.Tests
{
    internal class Program
    {
        ...
        private static void ReadResultTest()
        {
            var noResults = JsonConvert.DeserializeObject<GeocodingResult>(File.ReadAllText(@"examples\geocoding\google\noresults.json"));
        ...
        private static void TestGeofencing()
        {
            var florida = new GeoPoint(19.3806445, -99.1791765);
            ...
            PolygonFence.IsPointInPolygon(polySinFlorida, florida)
                .Dump("Este polígono NO contiene a Florida 36, debe ser False");
        }
    }
